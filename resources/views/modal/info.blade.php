          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="ip" value="0" id="hidden_ip_buy">
                  ...
                  <div class="form-group">
                    ...
                    <p class="alert alert-info">После бронирования техники – <a href="<?php echo asset("storage/contract.docx")?>">заполните договор (воспользовавшись шаблоном)</a>
                        и направьте подписанный в двух экземплярах документ в Отдел информационных технологий вашего филиала

                    </p>
                    <a href="<?php echo asset("storage/contract.docx")?>" class="btn btn-primary btn-block">Скачать бланк договора</a>
          </div>
